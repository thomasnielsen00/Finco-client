...
export const languageText = {
  norwegian: {
    ...
    //MARKED
    calculated_stock_value: "Kalkulert aksjeverdi",
    ...
    passwords_not_matching:
      "Passordene dine er ikke like, vennligst prøv igjen",
    ...
    sell_confirmation_body_second_part: "aksjer i",
